    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            AppTheme.specNavy.withValues(alpha: 0.18),
        ...
        future: Future.wait([
          ...
          UserParishPreferences.getPreferredParishIds().then((ids) =>
              BlogPostsRepository().listApproved(
                limit: 20,
                forParishIds: ids.isEmpty ? null : ids.toSet(),
              )),
...
class _OtherBlogTile extends StatelessWidget {
  ...
  static Widget _thumbPlaceholder() {
    return Container(
      ...
      child: Center(
        child: Icon(Icons.article_rounded, size: 28, color: AppTheme.specNavy.withValues(alpha: 0.25)),
      ),
    );
  }
