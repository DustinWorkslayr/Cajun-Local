...
import 'package:cajun_local/features/profile/data/repositories/user_roles_repository.dart';
...
class AdminDashboardScreen extends StatelessWidget {
  const AdminDashboardScreen({super.key, this.embeddedInShell = false, this.onNavigateToSection});
                    ...
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final statsList = [
                          _StatItem(
                            'Businesses',
                            stats?.businessesTotal ?? 0,
                            stats?.businessesPending ?? 0,
                            Icons.store_rounded,
                          ),
                          _StatItem(
                            'Reviews',
                          ...
                          _StatItem(
                            'Category banners',
                            stats?.bannersTotal ?? 0,
                            stats?.bannersPending ?? 0,
  ...
  void _navigate(BuildContext context, int index, {String? status}) {
    if (onNavigateToSection != null) {
      ...
      switch (index) {
        case 1:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminBusinessesScreen(status: status)));
          break;
        case 2:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminReviewsScreen(status: status)));
          break;
        case 3:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminClaimsScreen(status: status)));
          break;
        case 4:
          Navigator.of(
            context,
          ).push(MaterialPageRoute<void>(builder: (_) => AdminPendingApprovalsScreen(status: status)));
          break;
        case 5:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminImagesScreen(status: status)));
          break;
        case 7:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminBlogScreen(status: status)));
          break;
        case 8:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => AdminManageBannersScreen(status: status)));
          break;
        case 16:
          Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const AdminUserRolesScreen()));
          break;
        default:
          break;
      }
      ...
      child: Column(
        ...
        children: [
          ...
          if (pending > 0) ...[
            ...
            Text(
              '$pending pending',
              style: theme.textTheme.bodySmall?.copyWith(color: AppTheme.specRed, fontWeight: FontWeight.w600),
            ),
          ],
          const SizedBox(height: 8),
          Container(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    'Review',
                    style: theme.textTheme.labelMedium?.copyWith(color: AppTheme.specRed, fontWeight: FontWeight.w600),
                  ),
