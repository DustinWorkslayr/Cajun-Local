...
class AdminDealsScreen extends StatelessWidget {
  const AdminDealsScreen({super.key, this.status, this.embeddedInShell = false});

  final String? status;
  final bool embeddedInShell;

  void _openAddDeal(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const AdminAddDealScreen()));
  }
            ...
            return Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.of(
                    context,
                  ).push(MaterialPageRoute<void>(builder: (_) => AdminDealDetailScreen(dealId: d.id)));
                },
              ),
            );
          },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.add_rounded), tooltip: 'Add deal', onPressed: () => _openAddDeal(context)),
        ],
      ),
