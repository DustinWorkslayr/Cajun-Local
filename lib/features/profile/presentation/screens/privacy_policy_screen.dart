          ...
          Column(
            ...
            children: [
              ...
              _Section(
                ...
                body:
                    'Cajun Local is a members-only service. We reserve the right to accept, reject, or remove any member or business at our discretion. We prioritize locally owned businesses and do not allow mega corporations or large chains to join as listed businesses. By using the app or cajunlocal.com, you agree to our membership terms and community standards.',
              ),
              _Section(
                title: 'Data retention and security',
                body:
                    'We retain your information for as long as your account is active or as needed to provide the service and comply with legal obligations. We use reasonable technical and organizational measures to protect your data. No method of transmission or storage is 100% secure; we encourage strong passwords and prompt reporting of any suspected misuse.',
              ),
              _Section(
                title: 'Your choices and rights',
                body:
                    'You can update your profile and preferences in the app. You may request access to, correction of, or deletion of your personal information by contacting us (e.g., via the app or cajunlocal.com). If you are in a jurisdiction with additional privacy rights (e.g., GDPR, CCPA), you may have the right to object to certain processing, restrict processing, or data portability; contact us to exercise those rights.',
              ),
              _Section(
                title: 'Children',
                body:
                    'Cajun Local is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have collected such information, please contact us so we can delete it.',
              ),
              _Section(
                title: 'Contact',
                body:
                    'For privacy-related questions or requests, please contact us through the Cajun Local app or at cajunlocal.com.',
              ),
