          ...
          Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.store_rounded, size: 56, color: AppTheme.specGold),
                    ),
              ...
              _Section(
                ...
                body:
                    'Cajun Local is a members-only platform that connects our community with locally owned businesses. We are not a national marketplace or a home for big-box chains. Our focus is exclusively on local businesses—restaurants, shops, services, and venues that are part of the fabric of our region. You can learn more and join us at cajunlocal.com.',
              ),
              _Section(
                title: 'Local businesses only',
                body:
                    'We only list and support locally owned and operated businesses. We do not accept mega corporations, large national chains, or franchises that are not independently owned in our area. Our goal is to help real local owners reach their neighbors with deals, menus, events, and loyalty programs—so the community and the local economy both win.',
              ),
              _Section(
                title: 'Members only',
                body:
                    'Cajun Local is a members-only service. Both businesses and community members join by creating an account. This helps us keep the platform focused, respectful, and valuable. Members can browse and claim deals, enroll in punch cards, and support local; businesses can manage their listing, hours, menu, and promotions. We expect all members to follow our community standards.',
              ),
              _Section(
              ...
              _Section(
                title: 'No mega corps',
                body:
                    'We explicitly do not allow mega corporations or large chains to join as listed businesses. Our platform is for local ownership and local identity. If you are a local business owner and want to be part of Cajun Local, we welcome you to apply through the app or at cajunlocal.com.',
              ),
              _Section(
                title: 'Website and app',
                body:
                    'Cajun Local is available as this app and on the web at cajunlocal.com. Our privacy policy, terms, and support information apply to both. For the latest updates and to sign up, visit cajunlocal.com.',
              ),
