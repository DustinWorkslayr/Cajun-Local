...
class ScanPunchScreen extends ConsumerStatefulWidget {
  const ScanPunchScreen({super.key});

  @override
  ConsumerState<ScanPunchScreen> createState() => _ScanPunchScreenState();
}

class _ScanPunchScreenState extends ConsumerState<ScanPunchScreen> {
