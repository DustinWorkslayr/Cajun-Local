...
class PunchCardEnrollmentsScreen extends StatefulWidget {
  ...
  @override
  State<PunchCardEnrollmentsScreen> createState() => _PunchCardEnrollmentsScreenState();
}
              ...
              child: ListView(
                ...
                children: [
                  Text(
                    ...
                    style: theme.textTheme.labelLarge?.copyWith(color: AppTheme.specNavy.withValues(alpha: 0.7)),
                  ),
                    ...
                    (e) => Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: e.isRedeemed
                            ...
                            : Text('${e.currentPunches}/${e.punchesRequired}', style: theme.textTheme.bodyMedium),
                      ),
                    ),
                  ),
                ],
